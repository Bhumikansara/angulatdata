(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('nz-form-builder', ['exports', '@angular/core', '@angular/forms', '@angular/common'], factory) :
    (global = global || self, factory(global['nz-form-builder'] = {}, global.ng.core, global.ng.forms, global.ng.common));
}(this, (function (exports, core, forms, common) { 'use strict';

    /**
     * @fileoverview added by tsickle
     * Generated from: lib/form-builder.service.ts
    ...
    var FormBuilderService = /** @class */ (function () {
        ...
        /** @nocollapse */ FormBuilderService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function FormBuilderService_Factory() { return new FormBuilderService(); }, token: FormBuilderService, providedIn: "root" });
    ...
    var FormBuilderComponent = /** @class */ (function () {
        function FormBuilderComponent(fb) {
            this.fb = fb;
            this.formValues = new core.EventEmitter();
            this.checkboxArr = [];
        }
        /**
         * @return {?}
        ...
        function () {
            ...
            function (row) {
                if (row.required === true && row.pattern != '') {
                    _this.dynamicForm.addControl(row.name, new forms.FormControl({ value: '', disabled: row.disabled }, [forms.Validators.required, forms.Validators.pattern(row.pattern)]));
                }
                else if (row.pattern != '') {
                    _this.dynamicForm.addControl(row.name, new forms.FormControl({ value: '', disabled: row.disabled }, [forms.Validators.pattern(row.pattern)]));
                }
                else if (row.required === true) {
                    _this.dynamicForm.addControl(row.name, new forms.FormControl({ value: '', disabled: row.disabled }, [forms.Validators.required]));
                }
                else {
                    _this.dynamicForm.addControl(row.name, new forms.FormControl({ value: '', disabled: row.disabled }));
                }
            }));
        };
        /**
        ...
        FormBuilderComponent.propDecorators = {
            ...
            journey: [{ type: core.Input }],
            dataToUpdate: [{ type: core.Input }],
            formValues: [{ type: core.Output }]
        };
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/form-builder.module.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
...
//# sourceMappingURL=nz-form-builder.umd.js.map
