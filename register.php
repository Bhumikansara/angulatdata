	...
	elseif(strlen($lastname) < 3):
        ...
        try{
            ...
            if($check_email_stmt->rowCount()):
				...
				//print_r($token);exit;
                $insert_query = "INSERT INTO `users`(`firstname`,`lastname`,`email`,`password`,`company`) VALUES('$firstname','$lastname','$email','$password','$company')";
                ...
                $insert_stmt->bindValue(':company', password_hash($company, PASSWORD_DEFAULT),PDO::PARAM_STR);
